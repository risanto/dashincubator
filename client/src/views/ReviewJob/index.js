...
//import commentIcon from "../ReviewTask/comment.svg";
...
export default function ReviewJobView({ open, onClose, task, completionID }) {
  ...
  const completion =
    ...
    task.completions.find((completion) => completion.cid === completionID);
  ...
  return (
    ...
    >
      <div className={styles.container}>
        {!completion ? (
          <div>Error. Reload the page and try again</div>
        ) : (
          <>
            <div
              style={{
            ...
            >
              ...
              <div
                ...
                onClick={() =>
                  history.push(
                    ProfileLocation(completion?.completionUser.username)
                  )
                }
              >
                <UserAvatar
            ...
            >
              {addressMode ? (
                <input
                  ...
                  placeholder={
                    "ENTER YOUR DASH ADDRESS TO COMPLETE TASK APPROVAL"
                  }
                  value={dashAddress}
